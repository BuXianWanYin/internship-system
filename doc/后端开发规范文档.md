...
- **指导教师（ROLE_INSTRUCTOR）**：只能访问分配的学生数据
...
**实习日志批阅权限**：
- **查询权限**：`ROLE_SYSTEM_ADMIN`、`ROLE_STUDENT`、`ROLE_INSTRUCTOR`、`ROLE_CLASS_TEACHER`、`ROLE_SCHOOL_ADMIN`、`ROLE_COLLEGE_LEADER`
- **批阅权限**：`ROLE_SYSTEM_ADMIN`、`ROLE_INSTRUCTOR`、`ROLE_CLASS_TEACHER`、`ROLE_SCHOOL_ADMIN`、`ROLE_COLLEGE_LEADER`
- **数据权限过滤**：
  - 系统管理员：可查看所有日志
  - 学校管理员：可查看本校学生的日志
  - 学院负责人：可查看本院学生的日志
...
**成果审核权限**：
- **查询权限**：`ROLE_SYSTEM_ADMIN`、`ROLE_STUDENT`、`ROLE_INSTRUCTOR`、`ROLE_CLASS_TEACHER`、`ROLE_SCHOOL_ADMIN`、`ROLE_COLLEGE_LEADER`
- **审核权限**：`ROLE_SYSTEM_ADMIN`、`ROLE_INSTRUCTOR`、`ROLE_CLASS_TEACHER`、`ROLE_SCHOOL_ADMIN`、`ROLE_COLLEGE_LEADER`
- **数据权限过滤**：与实习日志相同
