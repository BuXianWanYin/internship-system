...
4. **ROLE_CLASS_TEACHER**：班主任（单个班级权限，可查看和批阅本班学生的实习数据）
5. **ROLE_INSTRUCTOR**：指导教师（分配学生权限，可查看和批阅分配学生的实习数据）
...
- **实习管理主菜单（internship-teacher）**：
  - **可见角色**：`ROLE_INSTRUCTOR`
  - **子菜单权限**：
    - **实习日志批阅**：`ROLE_INSTRUCTOR`
    - **周报批阅**：`ROLE_INSTRUCTOR`
    - **成果审核**：`ROLE_INSTRUCTOR`
    - **问题反馈处理**：`ROLE_INSTRUCTOR`、`ROLE_ENTERPRISE_MENTOR`、`ROLE_CLASS_TEACHER`
- **说明**：
  - 系统管理员可以看到所有实习管理子菜单
  - 学校管理员和学院负责人可以批阅日志、周报、成果
  - 学院负责人可以查看全学院的实习申请审核
  - 菜单已整合，避免重复的"实习管理"主菜单
