...
public class InternshipFeedbackController {
    ...
    @PreAuthorize("hasAnyRole('ROLE_STUDENT', 'ROLE_INSTRUCTOR', 'ROLE_ENTERPRISE_MENTOR', 'ROLE_CLASS_TEACHER')")
    @GetMapping("/page")
    ...
    @ApiOperation("回复问题反馈")
    @PreAuthorize("hasAnyRole('ROLE_INSTRUCTOR', 'ROLE_ENTERPRISE_MENTOR')")
    ...
    @PreAuthorize("hasAnyRole('ROLE_STUDENT', 'ROLE_INSTRUCTOR', 'ROLE_ENTERPRISE_MENTOR')")
