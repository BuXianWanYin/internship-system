...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '考勤表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '考勤组表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `attendance_group_rule`  (
  ...
  INDEX `idx_delete_flag`(`delete_flag` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '考勤组规则表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `attendance_group_student`  (
  ...
  INDEX `idx_student_id`(`student_id` ASC) USING BTREE,
  INDEX `idx_delete_flag`(`delete_flag` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '考勤组学生关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `attendance_group_time_slot`  (
  ...
  INDEX `idx_group_id`(`group_id` ASC) USING BTREE,
  INDEX `idx_delete_flag`(`delete_flag` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '考勤组时间段表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `class_info`  (
  ...
  `share_code` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '班级分享码',
  `share_code_expire_time` datetime(6) NULL DEFAULT NULL COMMENT '分享码过期时间',
  `share_code_generate_time` datetime(6) NULL DEFAULT NULL COMMENT '分享码生成时间',
  `share_code_use_count` int NOT NULL DEFAULT 0 COMMENT '分享码使用次数',
...
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '班级信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of class_info
-- ----------------------------
INSERT INTO `class_info` VALUES (20, '计算机科学与技术2021级1班', 'CS2021-1', 24, 2021, 126, NULL, NULL, NULL, 0, 1, 0, '2025-11-23 05:09:45.731507', '2025-11-23 08:08:05.854205');
INSERT INTO `class_info` VALUES (21, '软件工程2021级1班', 'SE2021-1', 25, 2021, 126, 'JPE33PUD', '2025-12-31 10:22:12.778000', '2025-12-01 10:22:12.778000', 1, 1, 0, '2025-11-23 05:09:45.731507', '2025-11-23 08:08:05.854205');
INSERT INTO `class_info` VALUES (22, '计算机科学与技术2021级1班', 'CS2021-1', 26, 2021, NULL, NULL, NULL, NULL, 0, 1, 0, '2025-11-23 05:09:45.731507', '2025-11-23 08:08:05.854205');
INSERT INTO `class_info` VALUES (23, 'ces', 'ccc', 24, 2025, 126, NULL, NULL, NULL, 0, 1, 0, '2025-11-25 07:14:01.057000', '2025-11-25 07:14:01.058000');
...
CREATE TABLE `college_info`  (
  ...
  `college_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '学院代码',
  `school_id` bigint NOT NULL COMMENT '所属学校ID',
  `dean_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '院长姓名',
...
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学院信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of college_info
-- ----------------------------
INSERT INTO `college_info` VALUES (23, '信息科学技术学院', 'PKU-IST', 9, '张院长', 124, '010-62751234', 1, 0, '2025-11-23 05:09:36.292021', '2025-11-23 05:09:43.892321');
INSERT INTO `college_info` VALUES (24, '计算机科学与技术系', 'THU-CS', 10, '李院长', 125, '010-62785001', 1, 0, '2025-11-23 05:09:36.292021', '2025-11-23 05:09:44.801883');
...
CREATE TABLE `comprehensive_score`  (
  ...
  INDEX `idx_student_id`(`student_id` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '综合成绩表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `enterprise_evaluation`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '企业评价表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `enterprise_info`  (
  `enterprise_id` bigint NOT NULL AUTO_INCREMENT COMMENT '企业ID（主键）',
  `user_id` bigint NULL DEFAULT NULL COMMENT '用户ID（外键，企业管理员账号）',
  `enterprise_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '企业名称',
  `enterprise_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '企业代码',
  ...
  `address` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '企业地址',
...
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '企业信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of enterprise_info
-- ----------------------------
INSERT INTO `enterprise_info` VALUES (10, 135, '腾讯科技', 'TENCENT', '91440300708461136T', '马化腾', 2000000000.00, '互联网', '广东省深圳市南山区科技园', '李经理', '0755-86013388', 'contact@tencent.com', '大型', '社交网络、游戏、金融科技', 1, '审核通过', '2025-11-23 05:10:06.000000', 122, 1, 0, '2025-11-23 05:09:55.901096', '2025-11-23 05:18:11.181245');
INSERT INTO `enterprise_info` VALUES (11, NULL, '测试自主实习', 'SELF_1764335470425', '21434324324', '32423', 324234.00, '324', '测试自主实习', '测试自主实习', '15144567855', '', '', '', 1, NULL, NULL, NULL, 1, 0, '2025-11-28 21:11:10.426000', '2025-12-01 07:58:47.688000');
INSERT INTO `enterprise_info` VALUES (17, 139, '萨法说法', 'ceshi', '91440300708461138T', '案说法', NULL, '计算机软件', '萨芬士大夫士大夫大师傅', '打发打发', '15455677656', 'asfsaf!q!@qq.com', '大型企业', '', 1, NULL, NULL, NULL, 1, 0, '2025-12-01 12:00:34.849000', '2025-12-01 12:00:34.850000');
...
CREATE TABLE `enterprise_mentor_info`  (
  `mentor_id` bigint NOT NULL AUTO_INCREMENT COMMENT '企业导师ID（主键）',
  `user_id` bigint NOT NULL COMMENT '用户ID（外键）',
  `enterprise_id` bigint NOT NULL COMMENT '所属企业ID（外键）',
  `mentor_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '导师姓名',
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '企业导师信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of enterprise_mentor_info
-- ----------------------------
INSERT INTO `enterprise_mentor_info` VALUES (11, 137, 10, '腾讯导师1', '高级工程师', '技术部', '13800005002', 'mentor001@tencent.com', 1, 0, '2025-11-23 05:10:00.680814', '2025-11-23 05:10:00.680814');
...
CREATE TABLE `enterprise_school_cooperation`  (
  ...
  INDEX `idx_delete_flag`(`delete_flag` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '企业学校合作关系表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '企业学校合作申请表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '阶段性成果表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `internship_apply`  (
  ...
  `self_industry` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `self_legal_person` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '实习申请表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `internship_feedback`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '问题反馈表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `internship_log`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE,
  INDEX `idx_plan_id`(`plan_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '实习日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `internship_plan`  (
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '实习计划表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `internship_post`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '实习岗位表' ROW_FORMAT = Dynamic;
...
INSERT INTO `internship_post` VALUES (12, 10, '12312', '213123', '213123', '12312', '3123', '123', 121, 0, 0, 2323.00, 23123.00, '月薪', '2025-12-09', '2025-12-26', '3213', '1231', '12312', '3123', 0, NULL, NULL, NULL, NULL, NULL, 0, '2025-12-01 08:58:44', '2025-12-01 08:58:44');
...
CREATE TABLE `internship_weekly_report`  (
  ...
  INDEX `idx_review_status`(`review_status` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '周报表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `interview`  (
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '面试表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `major_info`  (
  ...
  `major_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '专业代码',
...
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '专业信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of major_info
-- ----------------------------
INSERT INTO `major_info` VALUES (24, '计算机科学与技术', 'CS', 23, 4, NULL, 1, 0, '2025-11-23 05:09:37.943103', '2025-11-23 05:09:37.943103');
INSERT INTO `major_info` VALUES (25, '软件工程', 'SE', 23, 4, NULL, 1, 0, '2025-11-23 05:09:37.943103', '2025-11-23 05:09:37.943103');
INSERT INTO `major_info` VALUES (26, '计算机科学与技术', 'CS', 24, 4, NULL, 1, 0, '2025-11-23 05:09:37.943103', '2025-11-23 05:09:37.943103');
...
CREATE TABLE `permission_info`  (
  ...
  `permission_code` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '权限代码（唯一）',
  `permission_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '权限名称',
  `permission_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '权限类型：menu-菜单，button-按钮，api-接口',
  `parent_id` bigint NULL DEFAULT 0 COMMENT '父权限ID',
  `permission_desc` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '权限描述',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态：1-启用，0-禁用',
  `delete_flag` tinyint(1) NOT NULL DEFAULT 0 COMMENT '删除标志：0-未删除，1-已删除',
  `create_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `update_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_delete_flag`(`delete_flag` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '权限信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of permission_info
-- ----------------------------
INSERT INTO `permission_info` VALUES (1, 'system:school:view', '查看学校', 'api', 0, '查看学校列表和详情', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (2, 'system:school:add', '添加学校', 'api', 0, '添加新学校', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (3, 'system:school:edit', '编辑学校', 'api', 0, '编辑学校信息', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (4, 'system:school:delete', '删除学校', 'api', 0, '停用学校', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (5, 'system:college:view', '查看学院', 'api', 0, '查看学院列表和详情', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (6, 'system:college:add', '添加学院', 'api', 0, '添加新学院', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (7, 'system:college:edit', '编辑学院', 'api', 0, '编辑学院信息', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (8, 'system:college:delete', '删除学院', 'api', 0, '停用学院', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (9, 'system:major:view', '查看专业', 'api', 0, '查看专业列表和详情', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (10, 'system:major:add', '添加专业', 'api', 0, '添加新专业', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (11, 'system:major:edit', '编辑专业', 'api', 0, '编辑专业信息', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (12, 'system:major:delete', '删除专业', 'api', 0, '停用专业', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (13, 'system:class:view', '查看班级', 'api', 0, '查看班级列表和详情', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (14, 'system:class:add', '添加班级', 'api', 0, '添加新班级', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (15, 'system:class:edit', '编辑班级', 'api', 0, '编辑班级信息', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (16, 'system:class:delete', '删除班级', 'api', 0, '停用班级', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (17, 'system:class:sharecode', '管理分享码', 'api', 0, '生成和管理班级分享码', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (18, 'system:semester:view', '查看学期', 'api', 0, '查看学期列表和详情', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (19, 'system:semester:add', '添加学期', 'api', 0, '添加新学期', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (20, 'system:semester:edit', '编辑学期', 'api', 0, '编辑学期信息', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (21, 'system:semester:delete', '删除学期', 'api', 0, '删除学期', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (22, 'system:config:view', '查看配置', 'api', 0, '查看系统配置', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (23, 'system:config:add', '添加配置', 'api', 0, '添加系统配置', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (24, 'system:config:edit', '编辑配置', 'api', 0, '编辑系统配置', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (25, 'system:config:delete', '删除配置', 'api', 0, '删除系统配置', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (26, 'user:view', '查看用户', 'api', 0, '查看用户列表和详情', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (27, 'user:add', '添加用户', 'api', 0, '添加新用户', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (28, 'user:edit', '编辑用户', 'api', 0, '编辑用户信息', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (29, 'user:delete', '删除用户', 'api', 0, '停用用户', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
INSERT INTO `permission_info` VALUES (30, 'user:resetPassword', '重置密码', 'api', 0, '重置用户密码', 1, 0, '2025-11-20 18:28:25.277268', '2025-11-20 18:28:25.277268');
...
CREATE TABLE `role_info`  (
  ...
  `role_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '角色代码（唯一）',
...
-- ----------------------------
INSERT INTO `role_info` VALUES (1, 'ROLE_SYSTEM_ADMIN', '系统管理员', '系统管理员，拥有最高权限，可管理所有数据', 1, 0, '2025-11-20 18:28:11.418024', '2025-11-20 18:28:11.418024');
INSERT INTO `role_info` VALUES (2, 'ROLE_SCHOOL_ADMIN', '学校管理员', '学校管理员，可管理本校的所有数据', 1, 0, '2025-11-20 18:28:11.418024', '2025-11-20 18:28:11.418024');
INSERT INTO `role_info` VALUES (3, 'ROLE_COLLEGE_LEADER', '学院负责人', '学院负责人，可管理本院的所有数据', 1, 0, '2025-11-20 18:28:11.418024', '2025-11-20 18:28:11.418024');
INSERT INTO `role_info` VALUES (4, 'ROLE_CLASS_TEACHER', '班主任', '班主任，可管理本班的学生数据', 1, 0, '2025-11-20 18:28:11.418024', '2025-11-20 18:28:11.418024');
INSERT INTO `role_info` VALUES (5, 'ROLE_INSTRUCTOR', '指导教师', '指导教师，可管理分配的学生数据', 0, 1, '2025-11-20 18:28:11.418024', '2025-11-25 06:35:53.607912');
INSERT INTO `role_info` VALUES (6, 'ROLE_ENTERPRISE_ADMIN', '企业管理员', '企业管理员，可管理本企业的数据', 1, 0, '2025-11-20 18:28:11.418024', '2025-11-20 18:28:11.418024');
INSERT INTO `role_info` VALUES (7, 'ROLE_ENTERPRISE_MENTOR', '企业导师', '企业导师，可管理本企业的实习生数据', 1, 0, '2025-11-20 18:28:11.418024', '2025-11-20 18:28:11.418024');
INSERT INTO `role_info` VALUES (8, 'ROLE_STUDENT', '学生', '学生，只能查看和管理个人数据', 1, 0, '2025-11-20 18:28:11.418024', '2025-11-20 18:28:11.418024');
...
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色权限关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of role_permission
-- ----------------------------
INSERT INTO `role_permission` VALUES (1, 1, 1, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (2, 1, 2, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (3, 1, 3, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (4, 1, 4, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (5, 1, 5, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (6, 1, 6, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (7, 1, 7, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (8, 1, 8, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (9, 1, 9, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (10, 1, 10, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (11, 1, 11, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (12, 1, 12, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (13, 1, 13, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (14, 1, 14, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (15, 1, 15, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (16, 1, 16, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (17, 1, 17, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (18, 1, 18, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (19, 1, 19, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (20, 1, 20, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (21, 1, 21, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (22, 1, 22, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (23, 1, 23, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (24, 1, 24, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (25, 1, 25, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (26, 1, 26, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (27, 1, 27, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (28, 1, 28, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (29, 1, 29, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
INSERT INTO `role_permission` VALUES (30, 1, 30, 0, '2025-11-20 18:28:53.580104', '2025-11-20 18:28:53.580104');
...
CREATE TABLE `school_admin_info`  (
  ...
  `user_id` bigint NOT NULL COMMENT '用户ID（外键）',
  `school_id` bigint NOT NULL COMMENT '所属学校ID（外键）',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态：1-启用，0-禁用',
  `delete_flag` tinyint(1) NOT NULL DEFAULT 0 COMMENT '删除标志：0-未删除，1-已删除',
  `create_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `update_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT '更新时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学校管理员信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of school_admin_info
-- ----------------------------
INSERT INTO `school_admin_info` VALUES (9, 122, 9, 1, 0, '2025-11-23 05:09:35.376933', '2025-11-23 05:09:35.376933');
...
CREATE TABLE `school_evaluation`  (
  ...
  INDEX `idx_evaluator_id`(`evaluator_id` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学校评价表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `school_info`  (
  ...
  `school_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '学校代码',
  ...
  INDEX `idx_delete_flag`(`delete_flag` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学校信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of school_info
-- ----------------------------
INSERT INTO `school_info` VALUES (9, '北京大学', 'PKU', '北京市海淀区颐和园路5号', '张主任', '010-62751234', 1, 0, '2025-11-23 05:09:28.978941', '2025-11-23 05:09:28.978941');
INSERT INTO `school_info` VALUES (10, '清华大学', 'THU', '北京市海淀区清华园1号', '李主任', '010-62785001', 1, 0, '2025-11-23 05:09:28.978941', '2025-11-23 05:09:28.978941');
INSERT INTO `school_info` VALUES (11, '测试学校', 'TEST', '测试地址', '测试联系人', '13800138000', 1, 0, '2025-11-27 12:39:08.870000', '2025-11-27 19:30:40.953000');
...
CREATE TABLE `self_evaluation`  (
  ...
  INDEX `idx_student_id`(`student_id` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学生自评表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `semester_info`  (
  ...
  `is_current` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否当前学期：1-是，0-否',
  `delete_flag` tinyint(1) NOT NULL DEFAULT 0 COMMENT '删除标志：0-未删除，1-已删除',
  `create_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `update_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT '更新时间',
  ...
  INDEX `idx_delete_flag`(`delete_flag` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学期信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of semester_info
-- ----------------------------
INSERT INTO `semester_info` VALUES (9, '2024-2025学年第一学期', '2024-09-01', '2025-01-31', 9, 1, 0, '2025-11-23 05:10:26.155657', '2025-11-27 09:18:31.876000');
...
CREATE TABLE `student_info`  (
  ...
  `class_id` bigint NOT NULL COMMENT '所属班级ID（外键）',
  `enrollment_year` int NOT NULL COMMENT '入学年份',
  `graduation_year` int NULL DEFAULT NULL COMMENT '毕业年份',
  `major_id` bigint NULL DEFAULT NULL COMMENT '所属专业ID（冗余字段，便于查询）',
  `college_id` bigint NULL DEFAULT NULL COMMENT '所属学院ID（冗余字段，便于查询）',
  `school_id` bigint NULL DEFAULT NULL COMMENT '所属学校ID（冗余字段，便于查询）',
  ...
  `internship_status` int NULL DEFAULT 0 COMMENT '实习状态：0-未实习，1-实习中，2-已离职，3-已结束',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态：1-启用，0-禁用',
  `delete_flag` tinyint(1) NOT NULL DEFAULT 0 COMMENT '删除标志：0-未删除，1-已删除',
  `create_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `update_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT '更新时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 73 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '学生信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of student_info
-- ----------------------------
INSERT INTO `student_info` VALUES (66, 128, '2021001001', 20, 2021, NULL, 24, 23, 9, 24, 12, 1, 1, 0, '2025-11-23 05:09:51.909238', '2025-12-01 05:40:06.000000');
INSERT INTO `student_info` VALUES (67, 129, '2021001002', 20, 2021, NULL, 24, 23, 9, 22, 10, 3, 1, 0, '2025-11-23 05:09:51.909238', '2025-12-01 05:40:07.000000');
INSERT INTO `student_info` VALUES (72, 138, '123456', 21, 2021, NULL, 25, 23, 9, NULL, NULL, 0, 1, 0, '2025-12-01 10:32:37.436000', '2025-12-01 10:32:37.436000');
...
CREATE TABLE `system_config`  (
  ...
  INDEX `idx_delete_flag`(`delete_flag` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '系统配置表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of system_config
-- ----------------------------
INSERT INTO `system_config` VALUES (7, 'share_code_expire_days', '30', 'share_code', '分享码有效期（天）', 0, '2025-11-20 17:57:33.822433', '2025-11-20 17:57:33.822433');
INSERT INTO `system_config` VALUES (8, 'share_code_length', '8', 'share_code', '分享码长度', 0, '2025-11-20 17:57:33.822433', '2025-11-20 17:57:33.822433');
INSERT INTO `system_config` VALUES (9, 'system_notice_template_welcome', '欢迎使用高校实习管理系统！', 'notice_template', '欢迎通知模板', 1, '2025-11-20 17:57:33.822433', '2025-11-29 16:27:23.648326');
INSERT INTO `system_config` VALUES (11, 'enterprise_evaluation_weight', '0.4', 'evaluation', '企业评价权重', 0, '2025-11-28 20:08:39.000000', '2025-11-28 20:14:53.318000');
INSERT INTO `system_config` VALUES (12, 'school_evaluation_weight', '0.4', 'evaluation', '学校评价权重', 0, '2025-11-28 20:08:40.000000', '2025-12-01 07:38:46.242000');
INSERT INTO `system_config` VALUES (13, 'student_self_evaluation_weight', '0.2', 'evaluation', '学生自评权重', 0, '2025-11-28 20:08:41.000000', '2025-12-01 07:38:50.257000');
INSERT INTO `system_config` VALUES (26, 'self_internship_school_weight', '0.8', 'evaluation', '自主实习学校评价权重', 0, '2025-12-01 07:37:06.987724', '2025-12-01 07:37:06.987724');
INSERT INTO `system_config` VALUES (27, 'self_internship_self_weight', '0.2', 'evaluation', '自主实习学生自评权重', 0, '2025-12-01 07:37:07.679390', '2025-12-01 07:37:07.679390');
...
CREATE TABLE `teacher_info`  (
  `teacher_id` bigint NOT NULL AUTO_INCREMENT COMMENT '教师ID（主键）',
  `user_id` bigint NOT NULL COMMENT '用户ID（外键）',
  `teacher_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '工号（唯一）',
  `college_id` bigint NULL DEFAULT NULL COMMENT '所属学院ID（外键）',
  `school_id` bigint NULL DEFAULT NULL COMMENT '所属学校ID（冗余字段，便于查询）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '教师信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of teacher_info
-- ----------------------------
INSERT INTO `teacher_info` VALUES (21, 124, 'T001', 23, 9, '教授', '信息科学技术学院', 1, 0, '2025-11-23 05:09:42.212116', '2025-11-23 05:09:42.212116');
INSERT INTO `teacher_info` VALUES (23, 126, 'T003', 23, 9, '副教授', '信息科学技术学院', 1, 0, '2025-11-23 05:09:42.212116', '2025-11-23 05:09:42.212116');
...
) ENGINE = InnoDB AUTO_INCREMENT = 140 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户基础信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user_info
-- ----------------------------
INSERT INTO `user_info` VALUES (1, 'admin', '$2a$10$aeIKloPJ2jDx67IrxQGcMeXDH/kHdSnXGo95TXj1gqd3I8MZoI.Sy', '系统管理员', NULL, '13800000001', NULL, NULL, 'admin@example.com', '男', NULL, NULL, 1, 0, '2025-11-20 18:33:57.886889', '2025-12-01 10:01:09.640802');
INSERT INTO `user_info` VALUES (122, 'pku_admin', '$2a$10$aeIKloPJ2jDx67IrxQGcMeXDH/kHdSnXGo95TXj1gqd3I8MZoI.Sy', '北京大学管理员', NULL, '13800001001', NULL, NULL, 'pku_admin@pku.edu.cn', '男', NULL, NULL, 1, 0, '2025-11-23 05:09:30.702539', '2025-12-01 10:01:08.784019');
INSERT INTO `user_info` VALUES (124, 'pku_dean', '$2a$10$NdQcc9H/BdnJrWbBKSJnn.MP8Uh12pF2mRK85DfQA4m4EH6EKYdqG', '张院长', '', '13800002002', 'ccccccccc', 'sagasg asfasfga ', 'dean_ist@pku.edu.cn', '男', '', '/uploads/2025/11/25/da297383bb4e4ea4a21a1265ac9b87f1.jpg', 1, 0, '2025-11-23 05:09:39.628532', '2025-12-01 10:01:08.205230');
INSERT INTO `user_info` VALUES (126, 'pku_teacher1', '$2a$10$aeIKloPJ2jDx67IrxQGcMeXDH/kHdSnXGo95TXj1gqd3I8MZoI.Sy', '刘老师', NULL, '13800003001', NULL, NULL, 'teacher001@pku.edu.cn', '男', NULL, NULL, 1, 0, '2025-11-23 05:09:39.628532', '2025-12-01 10:01:07.510481');
INSERT INTO `user_info` VALUES (128, '2021001001', '$2a$10$aeIKloPJ2jDx67IrxQGcMeXDH/kHdSnXGo95TXj1gqd3I8MZoI.Sy', '张三', NULL, '13800004001', NULL, NULL, '2021001001@pku.edu.cn', '男', NULL, NULL, 1, 0, '2025-11-23 05:09:47.689660', '2025-12-01 09:58:04.938696');
INSERT INTO `user_info` VALUES (129, '2021001002', '$2a$10$aeIKloPJ2jDx67IrxQGcMeXDH/kHdSnXGo95TXj1gqd3I8MZoI.Sy', '李四', NULL, '13800004002', NULL, NULL, '2021001002@pku.edu.cn', '女', NULL, NULL, 1, 0, '2025-11-23 05:09:47.689660', '2025-12-01 09:58:05.435356');
INSERT INTO `user_info` VALUES (135, 'tencent_admin', '$2a$10$aeIKloPJ2jDx67IrxQGcMeXDH/kHdSnXGo95TXj1gqd3I8MZoI.Sy', '腾讯管理员', NULL, '0755-86013388', NULL, NULL, 'admin@tencent.com', '男', NULL, NULL, 1, 0, '2025-11-23 05:09:53.178510', '2025-12-01 10:01:13.254478');
INSERT INTO `user_info` VALUES (137, 'tencent_mentor1', '$2a$10$aeIKloPJ2jDx67IrxQGcMeXDH/kHdSnXGo95TXj1gqd3I8MZoI.Sy', '腾讯导师1', NULL, '13800005002', NULL, NULL, 'mentor001@tencent.com', '男', NULL, NULL, 1, 0, '2025-11-23 05:09:57.854518', '2025-12-01 10:01:11.692183');
INSERT INTO `user_info` VALUES (138, '123456', '$2a$10$aeIKloPJ2jDx67IrxQGcMeXDH/kHdSnXGo95TXj1gqd3I8MZoI.Sy', 'sfasfa', '', '', NULL, NULL, '', NULL, NULL, NULL, 1, 0, '2025-12-01 10:32:37.425000', '2025-12-01 11:54:34.031656');
INSERT INTO `user_info` VALUES (139, 'testadmin', '$2a$10$fw/hSrgw2r9pxRXlrPWbYejOzax6ZgfAiVJj62NZ/RUOoJG8TIzGC', '打发打发', NULL, '15455677656', NULL, NULL, 'asfsaf!q!@qq.com', NULL, NULL, NULL, 1, 0, '2025-12-01 12:00:34.935000', '2025-12-01 12:00:34.935000');
...
) ENGINE = InnoDB AUTO_INCREMENT = 160 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户角色关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user_role
-- ----------------------------
INSERT INTO `user_role` VALUES (1, 1, 1, 0, '2025-11-20 18:36:16.497588', '2025-11-20 18:36:16.497588');
INSERT INTO `user_role` VALUES (140, 122, 2, 0, '2025-11-23 05:09:32.700639', '2025-11-23 05:09:32.700639');
INSERT INTO `user_role` VALUES (142, 124, 3, 0, '2025-11-23 05:09:41.340248', '2025-11-23 05:09:41.340248');
INSERT INTO `user_role` VALUES (144, 126, 4, 0, '2025-11-23 05:09:41.340248', '2025-11-23 05:09:41.340248');
INSERT INTO `user_role` VALUES (145, 126, 5, 1, '2025-11-23 05:09:41.340248', '2025-11-25 06:36:01.048011');
INSERT INTO `user_role` VALUES (148, 128, 8, 0, '2025-11-23 05:09:49.452626', '2025-11-23 05:09:49.452626');
INSERT INTO `user_role` VALUES (149, 129, 8, 0, '2025-11-23 05:09:49.452626', '2025-11-23 05:09:49.452626');
INSERT INTO `user_role` VALUES (155, 135, 6, 0, '2025-11-23 05:09:54.994705', '2025-11-23 05:09:54.994705');
INSERT INTO `user_role` VALUES (157, 137, 7, 0, '2025-11-23 05:09:59.733414', '2025-11-23 05:09:59.733414');
INSERT INTO `user_role` VALUES (158, 138, 8, 0, '2025-12-01 10:32:56.430000', '2025-12-01 10:32:56.431000');
INSERT INTO `user_role` VALUES (159, 139, 6, 0, '2025-12-01 12:00:34.962000', '2025-12-01 12:00:34.962000');
